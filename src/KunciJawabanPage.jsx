...
export default function KunciJawabanPage() {
  ...
  const [rapor, setRapor] = useState("Bahasa Indonesia");
      ...
      <div className="bg-white border rounded-xl p-6 mb-4 flex flex-col gap-4" style={{maxWidth: '100%'}}>
        <div className="flex flex-wrap gap-8 items-center">
          ...
          <div className="flex flex-col flex-1 min-w-[180px] max-w-[220px]">
            ...
            <select className="border rounded-lg px-4 py-2 w-full bg-white" value={rapor} onChange={e => setRapor(e.target.value)}>
